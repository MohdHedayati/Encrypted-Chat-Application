...
public class HybridCryptography {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte [] decryptedMessage = decryptDataUsingAES(decryptedAESKey, cipherText);
        System.out.println("Decrypted Message: " + new String(decryptedMessage));

    }

    // functions
    // Function for AES Key generation
    ...
    // Function of Encryption using AES
    ...
    public static byte[] decryptDataUsingAES(SecretKey decryptedAESKey , byte [] messageInBytes ) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        Cipher cipher = Cipher.getInstance("AES");
